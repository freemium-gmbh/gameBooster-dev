...
/// <summary>
/// The <see cref="GameBooster.Routine"/> namespace contains a set of routine classes
/// of the <see cref="GameBooster"/> project
/// </summary>
namespace GameBooster.Routine
{
    /// <summary>
    ...
    public class TaskManager
    {
        ...
        public static void CreateDefaultTask(string taskName, bool isEnabled)
        {
            try
            {
                ...
                td.RegistrationInfo.Description = "GameBoosterUtilities 1 ClickMaint";
