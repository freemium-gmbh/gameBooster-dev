...
namespace GameBooster
{
    ...
    public class VisibilityAnimation
    {
        ...
        /// </summary>
        static readonly Dictionary<FrameworkElement, bool> HookedElements = new Dictionary<FrameworkElement, bool>();
            ...
            doubleAnimation.Completed += (sender, eventArgs) =>
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (BindingOperations.IsDataBound(frameworkElement, UIElement.VisibilityProperty))
                                                    {
                                                        ...
                                                        BindingOperations.SetBinding(frameworkElement, UIElement.VisibilityProperty,
                                                                                     bindingValue);
                                                    }
                                                    else
                                                    {
