    ...
    public partial class FormTaskManager : Form
    {
        ...
        public void btnOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Task task = service.FindTask("GameBooster1ClickMaint");
                ...
                {
                    td.RegistrationInfo.Description = "GameBooster 1 ClickMaint";
                ...
                if (isNewTask)
                    service.RootFolder.RegisterTaskDefinition(@"GameBooster1ClickMaint", td);
                else
